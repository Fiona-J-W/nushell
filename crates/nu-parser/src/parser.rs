...
pub fn parse_operator(working_set: &mut StateWorkingSet, span: Span) -> Expression {
    ...
    let operator = match contents {
        ...
        b"!=" | b"\xE2\x89\xA0" /* ≠ */ => Operator::Comparison(Comparison::NotEqual),
        b"<" => Operator::Comparison(Comparison::LessThan),
        b"<=" | b"\xE2\x89\xA4" /* ≤ */ => Operator::Comparison(Comparison::LessThanOrEqual),
        b">" => Operator::Comparison(Comparison::GreaterThan),
        b">=" | b"\xE2\x89\xA5" /* ≥ */ => Operator::Comparison(Comparison::GreaterThanOrEqual),
        b"=~" | b"like" => Operator::Comparison(Comparison::RegexMatch),
        b"!~" | b"not-like" => Operator::Comparison(Comparison::NotRegexMatch),
        b"in" | b"\xE2\x88\x88" /* ∈ */ => Operator::Comparison(Comparison::In),
        b"not-in" | b"\xE2\x88\x89" /* ∉ */ => Operator::Comparison(Comparison::NotIn),
        b"has" | b"\xE2\x88\x8B" /* ∋ */ => Operator::Comparison(Comparison::Has),
        b"not-has" | b"\xE2\x88\x8B" /* ∌ */ => Operator::Comparison(Comparison::NotHas),
        ...
        b"*" | b"\xc3\x97" /* × */ => Operator::Math(Math::Multiply),
        ...
        b"or" | b"\xE2\x88\xA8" /* ∨ */ => Operator::Boolean(Boolean::Or),
        b"xor" => Operator::Boolean(Boolean::Xor),
        b"and" | b"\xE2\x88\xA7" /* ∧ */ => Operator::Boolean(Boolean::And),
